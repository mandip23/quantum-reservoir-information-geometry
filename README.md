...
Among the indicators I tested, Quantum Susceptibility gave the clearest separation between the transition and control simulations. Quantum Speed Variance also showed a noticeable increase during the parameter drift, means that the reservoir dynamics become more active as the underlying system changes.
